...
// Modified from RAMPS v1.4 Board. To used with PiBot Control Board Rev2.3, comment out the above defines and uncomment the next two defines
#define DEFAULTS_PIBOT_REV23
#define CPU_MAP_2560_PIBOT_REV23
...
// NOTE: Defaults are set for a traditional 3-axis CNC machine. Z-axis first to clear, followed by X & Y.
  ...
  #define HOMING_CYCLE_0 (1<<Z_AXIS)   // Home Z axis
